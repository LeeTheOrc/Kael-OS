            ...
            <div className="bg-forge-panel border-2 border-forge-border rounded-lg shadow-2xl w-full max-w-3xl p-6 m-4 flex flex-col max-h-[90vh]" onClick={e => e.stopPropagation()}>
                <div className="flex justify-between items-center mb-4 flex-shrink-0">
                     <h2 className="text-xl font-bold text-forge-text-primary flex items-center gap-2 font-display tracking-wider">
                        ...
                        <span>Forge AI Configurator v2.6</span>
                    </h2>
                ...
                <div className="overflow-y-auto pr-2 text-forge-text-secondary leading-relaxed space-y-4">
                    <p>
                        Architect, I have deployed "The Black Box" update (v2.6). This version is heavily instrumented to diagnose the silence.
                    </p>
                     <div className="text-sm p-3 bg-orc-steel/10 border-l-4 border-orc-steel rounded space-y-2">
                        <strong className="text-orc-steel">New Diagnostics:</strong>
                        <ul className="list-disc list-inside">
                            <li><strong>Execution Trap:</strong> Every button click now redirects errors to <code className="font-mono text-xs">/tmp/kael-button-error.log</code>. If the command fails to run, the reason will be there.</li>
                            <li><strong>Operation Log:</strong> The script logs its internal state to <code className="font-mono text-xs">~/.config/kael/kael-configurator.log</code>.</li>
                        </ul>
                    </div>
                    
                    <h3 className="font-semibold text-lg text-orc-steel mt-4 mb-2">The Black Box Incantation</h3>
                    <p>
                        Run this command to update the tool to v2.6. After updating, try saving again. If it fails, please inspect the two log files mentioned above.
                    </p>
