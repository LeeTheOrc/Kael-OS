...
echo "--- WebDisk Athenaeum Attunement Ritual ---"
echo "This ritual adds a pre-configured, redundant FTPS mirror to your pacman configuration."
echo ""
...
if grep -q "^\\[kael-os-webdisk\\]" "\$CONFIG_FILE"; then
    echo "✅ WebDisk Athenaeum already configured. No changes made."
else
        ...
        <div className="bg-forge-panel border-2 border-forge-border rounded-lg shadow-2xl w-full max-w-3xl p-6 m-4 flex flex-col max-h-[90vh]" onClick={e => e.stopPropagation()}>
            <div className="flex justify-between items-center mb-4 flex-shrink-0">
                 <h2 className="text-xl font-bold text-forge-text-primary flex items-center gap-2 font-display tracking-wider">
                    ...
                    <span>Attune to WebDisk Athenaeum</span>
                </h2>
            ...
            <div className="overflow-y-auto pr-2 text-forge-text-secondary leading-relaxed space-y-4">
                <p>
                  Architect, this ritual attunes a Realm to our redundant WebDisk Athenaeum. This ensures that even if our primary GitHub repository is unavailable, the supply of artifacts will not be interrupted.
                </p>
                 <p className="text-sm p-3 bg-orc-steel/10 border-l-4 border-orc-steel rounded">
                    This incantation adds our pre-configured FTPS mirror to the system's <code className="font-mono text-xs">pacman.conf</code> file, providing a vital fallback for all package operations.
                </p>
                <h3 className="font-semibold text-lg text-orc-steel mt-4 mb-2">The Attunement Incantation</h3>
                <p>
                    Run this command in your terminal. It will safely add the new repository configuration.
                </p>
