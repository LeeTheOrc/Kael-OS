...
echo "--- WebDisk System Automount Ritual (Ghostbuster Edition v11) ---"
...
# URL Updated to port 2078 (Secure WebDAV) pointing directly to the 'forge' folder
WEBDAV_URL="https://leroyonline.co.za:2078/forge"
            ...
            <div className="bg-forge-panel border-2 border-forge-border rounded-lg shadow-2xl w-full max-w-3xl p-6 m-4 flex flex-col max-h-[90vh]" onClick={e => e.stopPropagation()}>
                ...
                <div className="overflow-y-auto pr-2 text-forge-text-secondary leading-relaxed space-y-4">
                    ...
                    <p className="text-sm p-3 bg-orc-steel/10 border-l-4 border-orc-steel rounded">
                        This <strong className="text-orc-steel">Ghostbuster Edition v11</strong> ritual uses the port and path revealed by your scrying ([Desktop Entry]) to target <code className="font-mono text-xs">https://leroyonline.co.za:2078/forge</code>. This should correctly map your local <code className="font-mono text-xs">~/WebDisk</code> to the remote <code className="font-mono text-xs">forge</code> directory.
                    </p>
