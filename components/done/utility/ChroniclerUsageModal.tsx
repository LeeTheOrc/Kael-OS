...
import { CloseIcon, BookOpenIcon, EyeIcon, ShellPromptIcon } from '../../core/Icons';
        ...
        <div className="fixed inset-0 bg-black/70 z-50 flex items-center justify-center animate-fade-in-fast" onClick={onClose}>
            <div className="bg-forge-panel border-2 border-forge-border rounded-lg shadow-2xl w-full max-w-3xl p-6 m-4 flex flex-col max-h-[90vh]" onClick={e => e.stopPropagation()}>
                ...
                <div className="overflow-y-auto pr-2 text-forge-text-secondary leading-relaxed space-y-4">
                    <p>
                        The Chronicler has been updated. All records are now stored in a more standard, centralized location.
                    </p>
                    ...
                    <div className="bg-orc-steel/10 border border-orc-steel/30 p-4 rounded-lg">
                        ...
                        <p className="text-sm mb-2 text-forge-text-primary">
                            Invoke the Chronicler manually to record sessions or protect dangerous commands.
                        </p>
                    ...
                    <p className="text-sm p-3 bg-forge-panel border-l-4 border-forge-border rounded mt-4">
                        <strong>New Scriptorium Location:</strong> <code className="font-mono text-xs">~/.local/share/chronicler/</code>
                    </p>
                </div>
            </div>
        </div>
